...
namespace hashes
{
	public class GhostsTask : 
		...
		IMagic
	{
		private static byte[] massiveByte = { 1, 2, 3 };
		private static int justANumber = 27;
		private Document document = new Document("firstDoc", Encoding.UTF8, massiveByte);
		...
		public void DoMagic()
		{
			...
			massiveByte[2] = Convert.ToByte(justANumber);
			justANumber += 3;
		}
